...
export const ComposerPrimaryActions = memo(function ComposerPrimaryActions({
  ...
  const renderStopGenerationButton = (insidePendingAction: boolean) => (
    <button
      type="button"
      className={cn(
        "flex cursor-pointer items-center justify-center rounded-full bg-orange-500 text-slate-950 shadow-xs shadow-orange-500/24 inset-shadow-[0_1px_--theme(--color-white/16%)] transition-transform hover:bg-orange-400 hover:scale-105 active:shadow-none",
        insidePendingAction
          ? "size-8 sm:size-7"
  ...
  const sendButton = (
    <button
      ...
      className={cn(
        ...
        isConnecting || isSendBusy || isPreparingWorktree || isRunning
